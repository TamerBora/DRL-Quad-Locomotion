    ...
    def __post_init__(self):
        ...
        self.events.randomize_reset_base.params = {
            "pose_range": {
                ...
                "y": (-0.5, 0.5),
                "z": (0.0, 0.2),
                # "roll": (-3.14, 3.14),   # caused instant terminations when spawning upside-down
                # "pitch": (-3.14, 3.14),  # with illegal_contact active
                "roll": (-0.4, 0.4),
                "pitch": (-0.4, 0.4),
                "yaw": (-3.14, 3.14),
            },
        ...
        self.rewards.create_joint_deviation_l1_rewterm("joint_deviation_hip_l1", -0.5, [".*_hip_joint"])
        ...
        # Widen exponential kernel: std=0.5 gives near-zero gradient at 1.0 m/s error;
        # std=sqrt(0.5)=0.707 gives 4x stronger signal at the same error magnitude
        ...
        # ------------------------------Commands------------------------------
        # Direct angular velocity commands (not heading-derived) for clean tracking.
        # heading_command=True derives ang_vel_z = stiffness * heading_error, which
        # changes every step and makes the tracking target a moving reference.
